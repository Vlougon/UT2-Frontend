            ...
            <div className='row g-3'>
                ...
                <div className='col-md-6'>
                    ...
                    <div className='input-group has-validation'>
                        ...
                        <input type="text" name="postal_code" id='postal_code' value={beneficiaryAddressData.postal_code} className='form-control' placeholder='Código Postal' aria-describedby='postal-code' autoComplete="off" onChange={handleAddressChange} onClick={handlePersonalDataInputs} />
                        <span className="input-group-text btn btn-orange" onClick={pcGenerator}>Generar C.P.</span>
                        <div className="invalid-feedback">
                            ¡Introduzca un Código Postal Adecuado (Es necesaria una Provincia)!
                        </div>
                    </div>
                </div>
