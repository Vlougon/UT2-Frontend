...
const HomePage = () => {
    //Crear los array src y alt para poder usar map y que de esta forma cambien dependiendo del botón
    // src = ["../images/heart.png", "../images/heart2.png"]
    // alt = ["Imagen del botón", "Imagen del botónn 2"]
