...
export default function FlashMessage({ flashMessgae, flashType, closeHandler }) {
    const IconRender = () => {
        switch (flashType) {
            case 'danger':
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-x-octagon-fill" viewBox="0 0 16 16">
            ...
            default:
                return (
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-bug-fill" viewBox="0 0 16 16">
    ...
    return (
        <div className={'alert alert-' + flashType + ' d-flex align-items-center justify-content-between fTop'} role="alert">
