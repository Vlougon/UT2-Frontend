    ...
    return (
        <div className='col-md-3'>
            ...
            <div className='input-group'>
                ...
                <input type="text" id='phone_number' name="phone_number" value={beneficiaryPhones[0].phone_number} className='form-control' placeholder='Número de Teléfono' aria-describedby='beneficiaryPhoneNumber' onChange={handlePhonesChange} />
