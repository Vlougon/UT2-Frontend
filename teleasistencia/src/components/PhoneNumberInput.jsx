    ...
    return (
        <div className='col-md-3'>
            ...
            <div className='input-group has-validation'>
                ...
                <input type="text" id='phone_number' name="phone_number" value={beneficiaryPhones.phone_number} className='form-control' placeholder='Número de Teléfono' aria-describedby='beneficiaryPhoneNumber' onChange={handlePhonesChange} />
