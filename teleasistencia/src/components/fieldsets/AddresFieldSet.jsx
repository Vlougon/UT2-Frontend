            ...
            <div className='row g-3'>
                ...
                <div className='col-md-6'>
                    ...
                    <div className='input-group has-validation' onClick={handlePersonalDataInputs}>
                        ...
                        <input type="text" name="postal_code" id='postal_code' value={addressData.postal_code} className='form-control' placeholder='Código Postal' aria-describedby='postal-code' autoComplete="off" onChange={handleAddressChange} />
